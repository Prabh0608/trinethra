...
app.post("/analyze", async (req, res) => {
  ...
  const prompt = `
              ...
              - On the basis of the supervisor's description connect the fello's work with its most suitable KPI present in ${rubricScore.kpis} and use the same label as mentioned in the kpis
              ...
              - Keep in mind that supervisors are honest but biased. like Helpfulness bias, Presence bias, Halo/horn effect , Recency bias 
